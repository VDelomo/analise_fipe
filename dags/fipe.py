...
def refined():
    ...
    df_fipe_layout = round(df_fipe_layout.groupby(["year_of_reference",
                                                   "brand",
                                                   "model",
                                                   "fuel",
                                                   "gear",
    ...
    df_fipe_2021.to_csv(r'\diretorio\output\fipe_2021.csv', sep=',',index=False)
    df_fipe_2022.to_csv(r'\diretorio\output\fipe_2022.csv', sep=',',index=False)
    df_fipe_2023.to_csv(r'\diretorio\output\fipe_2023.csv', sep=',',index=False)

def fipe_merge(df_fipe_refined):
    df_fipe_2021 = pd.read_csv(r'\diretorio\output\fipe_2021.csv')
    df_fipe_2022 = pd.read_csv(r'\diretorio\output\fipe_2022.csv')
    df_fipe_2023 = pd.read_csv(r'\diretorio\output\fipe_2023.csv')
    ...
    df_fipe_merge.to_csv(r'\output\fipe_merge.csv', sep=',',index=False)
